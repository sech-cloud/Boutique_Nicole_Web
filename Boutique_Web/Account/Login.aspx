<%@ Page Title="Iniciar sesión" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Boutique_Web.Account.Login" Async="true" %>
        ...
        <div class="col-md-6">
            <section id="loginForm">
                <div class="form-horizontal">
                    <h4>Bienvenido al Sistema de Boutique Nicole</h4>
                    <hr />
                    ...
                    <div class="form-group">
                        <div class=" col-md-8">
                            <div class="checkbox">
                                ...
                                <asp:Label runat="server" AssociatedControlID="RememberMe" CssClass="col-md-4">¿Recordar cuenta?</asp:Label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
